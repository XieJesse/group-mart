...
btn.addEventListener('click',(e)=>{
  var cartT = document.getElementsByClassName("db tr b f5 pb3")[0] ;
  // console.log(cartT) ;
  var cartTotal ;

  if (cartT == undefined) {
    cartT = document.getElementsByClassName("w_U9_0 w_U0S3 w_QcqU b")[0] ;
    var cartTotal = cartT.innerText.substring(1) ;
    // console.log(cartT) ;
  }
  else {
    var cartTotal = cartT.innerHTML.substring(1) ;
  }
  ...
  // console.log(cartTip) ;
  const matchesOne = document.querySelectorAll('[data-testid=category-accordion-Shopped]')[0].getElementsByClassName("pa3 pb0 ph4-m") ;
  const matchesTwo = document.querySelectorAll('[data-testid=category-accordion-Weight-adjusted]')[0].getElementsByClassName("pa3 pb0 ph4-m") ;
